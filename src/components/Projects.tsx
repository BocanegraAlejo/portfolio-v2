...
const projects = [
  {
    ...
    description: "Desarrollo de sitio web con reproductor de streaming, incluyendo la maquetación completa de la interfaz",
  ...
  },
  {
    ...
    description: "Desarrollo de juego de Realidad Aumentada web, enfocado en dispositivos móviles",
    tags: ["HTML", "CSS", "Vue.js", "AR.js","A-frame"],
  ...
  
  {
    ...
    description: "Desarrollo de Landing con formulario de contacto, para la marca registrada bajo mi nombre",
  ...
  {
    title: "Redtl Radios",
    description: "Diversos ajustes en el sitio web, implementación de streaming de video, sección Museo, entre otros.",
  ...
  },
  {
    ...
    description: "Desarrollo de Sitio dinámico completo con Panel de Administración ",
  ...
  return (
    <section id="proyectos" className="py-20">
      <div className="container">
        <h2 className="mb-16 text-3xl font-bold text-foreground sm:text-4xl">Proyectos Destacados</h2>
